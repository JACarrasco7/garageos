...
<template>
    <div class="max-w-4xl mx-auto py-8">
        <Link href="/" class="inline-flex items-center text-sm text-muted-foreground hover:text-foreground mb-4">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Historial de ofertas, reservas y pagos en el marketplace
                </CardDescription>
            </CardHeader>
            <CardContent>
                <Table>
