    ...
    <WebLayout>
        ...
        <div class="mb-8 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div class="glass-liquid rounded-3xl p-8">
                ...
                <p class="mt-1.5 text-base text-muted-foreground">
                    {{ vehicles?.length ?? 0 }}
                    {{ (vehicles?.length ?? 0) === 1 ? 'vehículo registrado' : 'vehículos registrados' }}
                    · vista general de tu flota
                </p>
            </div>
            <Button as-child class="glass-button inline-flex items-center gap-2 rounded-2xl px-6 py-3 text-sm font-semibold">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            ...
            <div class="flex flex-col h-full">
                <div class="glass-panel rounded-3xl overflow-hidden h-full">
